-- 073: Perluas pvp_my_matches() agar menyertakan nama gym & fighter (JOIN),
-- supaya UI lobby tidak perlu query tambahan. Return type berubah dari
-- SETOF pvp_matches -> TABLE custom, jadi perlu DROP dulu.

DROP FUNCTION IF EXISTS pvp_my_matches();
