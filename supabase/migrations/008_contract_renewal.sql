-- Kontrak fighter: saat contract_fights_left mencapai 0, fighter berisiko pensiun
-- (pindah ke status 'retired') tiap minggu jika tidak diperpanjang. Saat pensiun,
-- gaji bulanannya dikurangi dari monthly_expense gym.
...
begin
  ...
  select coalesce(sum(salary_monthly), 0) into v_retired_salaries from retired;
