-- Tambah variasi kejadian acak mingguan bergaya gosip media sosial (cuitan,
-- rumor, meme, podcast, dst) ke generate_random_fighter_events(). Pesan tetap
-- masuk fighter_news dan tampil di section "Kejadian Minggu Ini" yang sudah ada.
...
DECLARE
  ...
  v_gymwide_idx  integer[] := ARRAY[19,20,21,22,29];
BEGIN
