-- Lengkapi efek staf yang sebelumnya tidak berdampak:
-- - Ahli Gizi (Nutrisi): mempercepat pemulihan training load
-- - Fisioterapis (Pemulihan Cedera): mempercepat pemulihan cedera mingguan
-- (efek "Matchmaking & Promosi" untuk purse dan "Pemulihan Cedera" untuk
-- mengurangi risiko cedera ditangani di sisi client saat hasil tanding disimpan.)
