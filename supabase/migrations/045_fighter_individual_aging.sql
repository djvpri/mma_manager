-- Setiap fighter milik player kini bertambah usia (age+1) tepat di minggu
-- ulang tahunnya sendiri (birth_week), bukan lagi global setiap 12 minggu
-- (yang sebelumnya tidak benar-benar mengubah age fighter milik player).
...
BEGIN
  ...
  -- ── Ulang tahun fighter (moral naik + bertambah usia 1 tahun) ─────────────
  UPDATE fighters SET morale = LEAST(100, morale + 5), age = age + 1
