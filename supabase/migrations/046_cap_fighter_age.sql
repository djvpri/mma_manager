-- Fix: kolom fighters.age dibatasi check constraint (18-45). Tanpa cap, fighter
-- yang sudah berusia 45 (pemain, prospek pool, atau CPU) dan bertambah usia
-- (ulang tahun / pool aging / CPU aging) akan melanggar fighters_age_check dan
-- membuat seluruh advance_week() gagal (error "violates check constraint
-- fighters_age_check"). Tambahkan LEAST(45, age + 1) di tiga tempat tersebut.
